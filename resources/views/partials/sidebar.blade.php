    ...
    <ul class="sidebar-nav">
      ...
      @if (Auth::check() && (Auth::user()->role->slug === 'super-admin' || Auth::user()->role->slug === 'administrator' || Auth::user()->role->slug === 'moderator')) --}}
        ...
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('schedule.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.schedule.index') : route('moderator.schedule.index') ) }}">
          ...
          <span class="align-middle">{{ __('Cài đặt ca') }}</span>
        </a>
        </li>
        <li class="sidebar-item">
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('shiftschedule.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.shiftschedule.index') : route('moderator.shiftschedule.index') ) }}">
          <i class="fa-solid fa-clock"></i>
          <span class="align-middle">{{ __('Phân ca') }}</span>
        </a>
        </li>
      {{-- @endif
        @if (Auth::check() && (Auth::user()->role->slug === 'super-admin' || Auth::user()->role->slug === 'administrator' || Auth::user()->role->slug === 'moderator')) --}}
        <li class="sidebar-item">
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('worktypes.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.worktypes.index') : route('moderator.worktypes.index') ) }}">
          <i class="fa-solid fa-calendar-days"></i>
          <span class="align-middle">{{ __('Cài đặt công') }}</span>
        </a>
        </li>
      {{-- @endif
      ...
      @if (Auth::check() && (Auth::user()->role->slug === 'super-admin' || Auth::user()->role->slug === 'administrator' || Auth::user()->role->slug === 'moderator')) --}}
        ...
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('attendance.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.attendance.index') : route('moderator.attendance.index') ) }}">
          <i class="fa-solid fa-calendar-days"></i>
          <span class="align-middle">{{ __('Dữ liệu chấm công') }}</span>
        </a>
        </li>
      {{-- @endif
      @if (Auth::check() && (Auth::user()->role->slug === 'super-admin' || Auth::user()->role->slug === 'administrator' || Auth::user()->role->slug === 'moderator')) --}}
        <li class="sidebar-item">
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('work_hours.index') : (Auth::user()->role->slug === 'administrator' ? route('admin.work_hours.index') : route('moderator.work_hours.index') ) }}">
          <i class="fa-solid fa-calendar-days"></i>
          <span class="align-middle">{{ __('Quét thẻ chấm công') }}</span>
        </a>
        </li>
      {{-- @endif
      ...
      @if (Auth::check() && (Auth::user()->role->slug === 'super-admin' || Auth::user()->role->slug === 'administrator' || Auth::user()->role->slug === 'moderator')) --}}
        ...
        <a class="sidebar-link" href="{{ Auth::user()->role->slug === 'super-admin' ? route('sheet.report') : (Auth::user()->role->slug === 'administrator' ? route('admin.sheet.report') : route('moderator.sheet.report') ) }}">
          ...
          <span class="align-middle">{{ __('Báo cáo công') }}</span>
        </a>
        </li>
      {{-- @endif
