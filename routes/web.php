...
Route::middleware('superadmin')->prefix('super')->group( function () {
    ...
    Route::get('/showdata', [YourControllerName::class, 'showData'])->name('attendance.showdata');
    Route::post('/attendance/savemita', [AttendanceController::class, 'savemita'])->name('attendance.savemita');
    Route::post('/attendance/deletemita', [AttendanceController::class, 'deleteMita'])->name('attendance.deletemita');


Route::get('/attendance', [AttendanceController::class, 'index'])->name('attendance.index');
Route::post('/attendance/calculate', [AttendanceController::class, 'calculate'])->name('attendance.calculate');

   
    Route::post('schedules_detail/store', [ScheduleController::class, 'storedetail'])->name('schedule.storedetail');
    

    Route::post('schedules_detail/destroy', [ScheduleController::class, 'destroydetail'])->name('schedule.destroydetail');

    Route::resource('shiftschedule', ShiftScheduleController::class);;
    Route::get('work_hours', [WorkHoursController::class, 'index'])->name('work_hours.index');
    Route::post('work_hours/calculate', [WorkHoursController::class, 'calculate'])->name('work_hours.calculate');

    Route::get('/attendance', [AttendanceController::class, 'index'])->name('attendance.index');

    Route::post('/admin/shiftschedule/store', [ShiftScheduleController::class, 'store'])->name('shiftschedule.store');
